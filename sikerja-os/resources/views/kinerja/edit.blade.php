                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group" data-target-input="nearest">
                                                        <input type="date" class="form-control" name="tgl_mulai"
                                                            ...
                                                            value="{{ old('tgl_mulai', $kinerjas->tgl_mulai) }}" />
                                                    </div>
                                                    @error('tgl_mulai')
                                                        <div class="invalid-feedback">
                                                            <p class="text-danger"> {{ $message }}</p>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group clockpicker" id="clockpicker"
                                                        data-target-input="nearest" data-placement="bottom"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group clockpicker" id="clockpicker"
                                                        ...
                                                        <input type="time" class="form-control" name="jam_selesai"
                                                            id="jam_selesai"
                                                            value="{{ old('jam_selesai', $kinerjas->jam_selesai) }}" />
                                                        <div class="input-group-append" data-target="#clock"
                                                            data-toggle="datetimepicker">
                                                            <div class="input-group-text"><i class="far fa-clock"></i>
                                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="custom-file">
                                                <input type="file"
                                                    ...
                                                    value="{{ old('file', $kinerjas->file) }}">
                                                <label class="custom-file-label"
                                                    for="InputFile">{{ $kinerjas->file }}</label>
                                            </div>
                                            @error('file')
                                                <div class="invalid-feedback">
                                                    <p class="text-danger"> {{ $message }}</p>
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" class="btn btn-primary"
                                                style="position:absolute;right:0;bottom:0;">Update</button>
                                        </div>
                                    </div>
                                    {{-- end here --}}
                                </div>
